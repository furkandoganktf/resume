...
class Contact extends Component {
   ...
   handleSubmit = (event) => {
      ...
      this.sendFeedback({ message_html: this.state.message, subject: this.state.subject, from_name: this.state.name, reply_to: this.state.email, to_name: "Furkan Doğan" });
         ...
         <section id="contact">
            ...
            <div className="row">
               <div className="eight columns">
                  ...
                  <div id="message-warning" style={this.state.errorMessage}>> There maybe some errors</div>
